    ...
    public static ArrayList<Earthquake> extractEarthquakes() {
        ...
        try {
            ...
            for (int i = 0; i<JSONArray.length(); i++){
                ...
                double magnitude = eachObject.optJSONObject("properties").getDouble("mag");
                String place = eachObject.optJSONObject("properties").getString("place");
                long date = eachObject.optJSONObject("properties").optLong("time");
                String url = eachObject.optJSONObject("properties").getString("url");
